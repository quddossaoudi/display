...
class Work extends Component {
  constructor(props) {
    ...
    this.workDetails = [
      ...
      {
        number: '01',
        projectName: 'Robin Room',
        projectDesc: 'Swiss Web app that allows companies and communities to come together.',
        projectType: 'WEB APP',
      ...
      },
      {
        number: '02',
        projectName: 'MyServe',
        projectDesc: "German Mobile app and website for senior citizen to book services based on their needs.",
